...
import data from "./floorplan-data";

import CameraSetup from "./CameraSetup";
import FloorPlan from "./FloorPlan";
import Ground from "./Ground";
import FloorClip from "./FloorClip";
  ...
  return (
    ...
    <div className="App">
      ...
      <div className="help">
        ...
        <div>
          toggle perspective/isometric and corners from controls at top-right
        </div>
      </div>
        ...
        {Array.from({ length: newItem.floors.length }).map((_, i) => {
          ...
          return (
            <div key={`room-${floorNumber}`}>
              <label
                htmlFor={`room-${floorNumber}`}
              >{`room ${floorNumber}`}</label>
              <input
                type="radio"
